...
const PERSONAS: PersonaDetails[] = [
  { id: "fan", title: "Fan Experience", description: "Your personal Matchday Companion.", icon: Users, href: "/fan", color: "bg-fifa-blue/10 text-fifa-blue", loadingSteps: ["Curating matchday experience...", "Analyzing optimal routes...", "Syncing digital twin..."], metric: 1200000, metricLabel: "Fans Connected", href: "/", loadingSteps: [] },
  { id: "organizer", title: "Control Room", description: "Operational intelligence and crowd heatmaps.", icon: Briefcase, href: "/organizer", color: "bg-fifa-red/10 text-fifa-red", loadingSteps: ["Initializing executive summary...", "Aggregating telemetry...", "Loading spatial models..."], metric: 12, metricLabel: "Active Incidents", href: "/", loadingSteps: [] },
  { id: "ops", title: "Field Operations", description: "Command center for ground ops and crowd control.", icon: ShieldCheck, href: "/ops", color: "bg-fifa-green/10 text-fifa-green", loadingSteps: ["Establishing secure connection...", "Mapping sector zones...", "Syncing incident logs..."], metric: 248, metricLabel: "Active Tasks", href: "/", loadingSteps: [] },
  { id: "staff", title: "Venue Staff", description: "Live work orders and maintenance routing.", icon: ClipboardList, href: "/staff", color: "bg-fifa-gold/10 text-fifa-gold", loadingSteps: ["Loading task matrix...", "Syncing communication nodes...", "Activating copilot..."], metric: 82, metricLabel: "Staff Online", href: "/", loadingSteps: [] }
];
